...
const Fingerprint = makeIcon(<><path d="M12 3a7 7 0 0 0-7 7c0 2 .4 3.4 1.2 5"/><path d="M12 3a7 7 0 0 1 7 7c0 .8-.05 1.5-.15 2.2"/><path d="M8.5 20.5c-1-1.3-1.7-2.7-2.1-4.2M9 10a3 3 0 0 1 6 0c0 3-1 5-1 7.5"/><path d="M12 10v3.5c0 2.5.6 4.3 1.8 6"/><path d="M6 10a6 6 0 0 1 .5-2.4M17.9 17.5A11 11 0 0 0 19 12"/></>);
...
const Calendar = makeIcon(<><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 9.5h18M8 3v4M16 3v4"/></>);
...
// ══════════════════════════════════════════════════════════════════════════════
// قائمة المناطق الحقيقية المعتمدة — العنوان يجب أن يطابق واحدة منها تماماً (لا
// كتابة حرة)، فتُستخدم إحداثياتها الحقيقية مباشرة لحساب مسافة وسعر دقيقين، بدل
// أي تخمين أو ترميز جغرافي احتياطي قد يخطئ لمكان غير موجود فعلاً.
const NEIGHBORHOODS = [
  // ── الخرطوم الكبرى ──
  { name:"السوق العربي",   lat:15.592, lng:32.532 },
  { name:"الخرطوم 2",      lat:15.578, lng:32.535 },
  { name:"الخرطوم 3",      lat:15.583, lng:32.545 },
  { name:"العمارات",       lat:15.556, lng:32.548 },
  { name:"الرياض",         lat:15.548, lng:32.575 },
  { name:"الرياض الجديد",  lat:15.542, lng:32.580 },
  { name:"بري",            lat:15.560, lng:32.585 },
  { name:"بري شرق",        lat:15.555, lng:32.598 },
  ...
  { name:"الجريف شرق",     lat:15.558, lng:32.575 },
  { name:"كلاكلة",         lat:15.450, lng:32.530 },
  { name:"كلاكلة القبة",   lat:15.445, lng:32.540 },
  { name:"سوبا",           lat:15.440, lng:32.620 },
  { name:"سوبا شرق",       lat:15.435, lng:32.635 },
  { name:"مايو",           lat:15.430, lng:32.570 },
  { name:"ود حسين",        lat:15.520, lng:32.520 },
  { name:"الديم",          lat:15.575, lng:32.520 },
  { name:"جبرة",           lat:15.565, lng:32.515 },
  { name:"الفتيحاب",       lat:15.500, lng:32.505 },
  { name:"الصحافة",        lat:15.610, lng:32.560 },
  { name:"السجانة",        lat:15.598, lng:32.545 },
  { name:"الشجرة",         lat:15.510, lng:32.545 },
  { name:"أبو سعد",        lat:15.520, lng:32.560 },
  { name:"المسالمة",       lat:15.545, lng:32.518 },
  { name:"أمدرمان",        lat:15.644, lng:32.478 },
  { name:"أم درمان",       lat:15.644, lng:32.478 },
  ...
  { name:"بيت المال",      lat:15.645, lng:32.470 },
  { name:"كرري",           lat:15.680, lng:32.470 },
  { name:"بحري",           lat:15.617, lng:32.533 },
  { name:"الخرطوم بحري",   lat:15.617, lng:32.533 },
  { name:"المنشية",        lat:15.585, lng:32.533 },
  { name:"الكدرو",         lat:15.660, lng:32.560 },
  { name:"الحلفايا",       lat:15.650, lng:32.540 },
  { name:"شمبات",          lat:15.670, lng:32.520 },
  { name:"الدروشاب",       lat:15.605, lng:32.525 },
  { name:"شرق النيل",      lat:15.620, lng:32.610 },
  { name:"الحاج يوسف",     lat:15.650, lng:32.580 },
  { name:"كافوري",         lat:15.600, lng:32.570 },

  // ── مدن السودان الكبرى (حسب الولايات) ──
  { name:"بورتسودان",      lat:19.6158, lng:37.2164 },
  { name:"كسلا",           lat:15.4500, lng:36.4000 },
  { name:"القضارف",        lat:14.0333, lng:35.4000 },
  { name:"الأبيض",         lat:13.1833, lng:30.2167 },
  { name:"بارا",           lat:13.7000, lng:30.3667 },
  { name:"الرهد",          lat:12.7167, lng:30.6500 },
  { name:"نيالا",          lat:12.0500, lng:24.8833 },
  { name:"الفاشر",         lat:13.6289, lng:25.3494 },
  { name:"الجنينة",        lat:13.4522, lng:22.4453 },
  { name:"زالنجي",         lat:12.9067, lng:23.4711 },
  { name:"الضعين",         lat:11.4667, lng:26.1333 },
  { name:"كادقلي",         lat:11.0167, lng:29.7167 },
  { name:"ود مدني",        lat:14.4012, lng:33.5199 },
  { name:"الحصاحيصا",      lat:14.2000, lng:33.0500 },
  { name:"المناقل",        lat:14.2417, lng:32.9975 },
  { name:"كوستي",          lat:13.1667, lng:32.6667 },
  { name:"ربك",            lat:13.1833, lng:32.7333 },
  { name:"سنار",           lat:13.5667, lng:33.6167 },
  { name:"سنجة",           lat:13.1500, lng:33.9333 },
  { name:"الدمازين",       lat:11.7833, lng:34.3500 },
  { name:"عطبرة",          lat:17.7000, lng:33.9833 },
  { name:"الدامر",         lat:17.5900, lng:33.9700 },
  { name:"شندي",           lat:16.6889, lng:33.4344 },
  { name:"دنقلا",          lat:19.1667, lng:30.4833 },
];

const PRICING = { km: 650, min: 20 }; // سعر الكيلومتر والحد الأدنى للطلب
...
// ── حالة الاتصال الفعلية للسائق — لا نثق بحقل online وحده أبداً ────────────────
// لو أغلق السائق التطبيق فجأة (أو انقطع نته) من غير ما يفصّل التبديل يدوياً،
// يبقى online=true في Firestore عالقاً للأبد بلا تصحيح تلقائي. لذلك نطلب أيضاً
// نبضة موقع حديثة فعلياً (location.updatedAt) خلال آخر دقيقتين — وإلا يُعتبر
// غير متصل، حتى لو الحقل الخام يقول العكس.
const ONLINE_STALE_MS = 120000;
function isDriverOnline(driver) {
  if (!driver || !driver.online) return false;
  const ts = driver.location && driver.location.updatedAt;
  if (!ts) return false;
...
// عكس الترميز الجغرافي — اسم مقروء لإحداثية معيّنة عبر Nominatim (OpenStreetMap، مجاني بلا مفتاح API)
...
// الترميز الجغرافي الأمامي — من اسم منطقة/عنوان مكتوب إلى إحداثيات حقيقية.
// نتحقق أولاً من قائمة الأحياء المعروفة محلياً (فوري، بلا شبكة)، ثم نطلب من
// Nominatim كخطوة ثانية لأي عنوان غير موجود فيها، فمركز الخرطوم كخط رجوع أخير
// فقط — حتى لا يتعطل إنشاء الطلب أبداً بسبب فشل عنوان غير معروف.
async function forwardGeocode(query) {
  const clean = String(query || "").trim();
  if (!clean) return { ...DEFAULT_CENTER };
  const known = NEIGHBORHOODS.find(n => clean.includes(n.name) || n.name.includes(clean));
  if (known) return { lat: known.lat, lng: known.lng };
  try {
    const res = await fetch(`https://nominatim.openstreetmap.org/search?format=json&q=${encodeURIComponent(clean + ", السودان")}&limit=1&accept-language=ar`);
    const data = await res.json();
...
// ══════════════════════════════════════════════════════════════════════════════
// قفل التطبيق بالبصمة — WebAuthn الحقيقي (Platform Authenticator)
// هذا يُفعّل مستشعر البصمة/الوجه الفعلي في الجهاز عبر نظام التشغيل والمتصفح
// مباشرة؛ التطبيق لا يرى أو يخزّن أي بيانات بصمة إطلاقاً — فقط معرّف اعتماد
// مُرجَّع من نظام التشغيل بعد نجاح التحقق محلياً على الجهاز نفسه.
// ══════════════════════════════════════════════════════════════════════════════
const LS_LOCK = "order_app_lock"; // { enabled, credentialId } — محلي لهذا الجهاز فقط، بلا مزامنة
...
// تسجيل بصمة جديدة لقفل الجهاز — يُظهر نافذة البصمة الأصلية لنظام التشغيل
async function registerBiometric(accountId, accountName) {
  const cred = await navigator.credentials.create({
    publicKey: {
      challenge: crypto.getRandomValues(new Uint8Array(32)),
      rp: { name: "Order" },
      user: {
        id: new TextEncoder().encode(String(accountId || "order-user")),
        name: accountName || "مستخدم Order",
        displayName: accountName || "مستخدم Order",
      },
  ...
  if (!cred) throw new Error("تعذّر تسجيل البصمة");
  return bufToB64url(cred.rawId);
}

// التحقق من البصمة عند فتح التطبيق أو قبل إلغاء القفل — يُظهر نفس نافذة البصمة الأصلية
...
// تحقّق فعلي من رقم سوداني محلي (9 أرقام بعد +249) — لا نكتفي أبداً بعدّ الأرقام؛
// نرفض الأنماط الواضح أنها غير حقيقية (نفس الرقم مكرراً، تسلسل صاعد/هابط)، ونتحقق
// أن الرقم يبدأ بـ9 أو 1 كما تشترطه شبكات السودان المحمولة (زين، MTN، سوداني).
function isValidSudanPhone(digits) {
...
function detectCarrier(digits) {
  ...
  return SUDAN_CARRIERS.find(c => c.prefixes.includes(p2)) || null;
}
...
// تحويل صورة إلى Base64 مضغوطة تُخزَّن مباشرة داخل مستند المستخدم في Firestore —
// لا نستخدم Firebase Storage إطلاقاً (يتطلب خطة مدفوعة)، فنُصغّر الصورة عبر
// Canvas أولاً لضمان بقائها ضمن حد حجم مستند Firestore (1 ميغابايت) بارتياح.
...
async function uploadAvatar(uid, file) {
  if (!file) return null;
  return withTimeout(fileToCompressedDataUrl(file), 15000, "معالجة الصورة استغرقت وقتاً طويلاً");
}
...
function usernameAuthErrorMessage(e) {
  ...
  if (code === "auth/internal-error") return "تعذّر إتمام العملية الآن، حاول مرة أخرى بعد قليل";
  if (code === "auth/user-disabled") return "هذا الحساب مُعطَّل";
...
function friendlyError(e, fallback) {
  ...
  const map = {
    ...
    "auth/too-many-requests": "محاولات كثيرة ومتتالية، حاول لاحقاً",
    "auth/network-request-failed": "تعذّر الاتصال بالخادم، تحقّق من اتصالك بالإنترنت",
    "auth/requires-recent-login": "لأمان حسابك، سجّل الخروج والدخول من جديد قبل هذا الإجراء",
    "auth/user-not-found": "الحساب غير موجود",
    "auth/user-disabled": "هذا الحساب مُعطَّل",
    "auth/internal-error": "تعذّر إتمام العملية الآن، حاول مرة أخرى بعد قليل",
    "permission-denied": "ليست لديك صلاحية لتنفيذ هذا الإجراء",
    "unavailable": "الخدمة غير متاحة الآن، حاول لاحقاً",
  };
...
function LocationPickerScreen({ title, initial, centerHint, onConfirm, onCancel }) {
  ...
  // عكس الترميز الجغرافي لإظهار اسم مقروء للنقطة
  useEffect(() => {
    if (moving) return;
...
// ── Welcome Screen ────────────────────────────────────────────────────────────
// ── شاشة الحساب المحظور — يُعرَض عند تسجيل الدخول بحساب حظره المسؤول، أو فوراً
//    إذا حُظر أثناء استخدام التطبيق (نفس اللحظة، عبر الاشتراك الحي بحساب المستخدم) ──
function BannedScreen({ onDismiss }) {
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-center" dir="rtl">
      ...
      <h1 className="font-black text-gray-950 text-xl mb-2">تم حظر حسابك</h1>
      <p className="text-gray-500 text-sm max-w-xs leading-relaxed mb-8">
        تعذّر تسجيل الدخول لأن هذا الحساب موقوف حالياً. إن كنت تعتقد أن هذا خطأ، تواصل مع الدعم.
      </p>
      <button onClick={onDismiss} className="bg-gray-950 text-white px-8 py-3 rounded-xl font-bold text-sm">حسناً</button>
    </div>
  );
}

// ── شاشة القفل — تظهر عند فتح التطبيق إن كان قفل البصمة مفعّلاً، وتحجب كل شيء
//    حتى ينجح التحقق الفعلي عبر مستشعر الجهاز ──────────────────────────────────
function LockScreen({ credentialId, onUnlock, onResetLock }) {
  ...
  const tryUnlock = async () => {
    ...
    try {
      ...
      setError("تعذّر التحقق من بصمتك، حاول مرة أخرى");
    } finally {
      setBusy(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center p-6 text-center" dir="rtl">
      ...
      <h1 className="text-white font-black text-xl mb-2">التطبيق مقفل</h1>
      <p className="text-gray-400 text-sm mb-8 max-w-xs">استخدم بصمتك لفتح التطبيق</p>
      {error && <p className="moter-field-error justify-center bg-red-500/10 rounded-xl px-4 py-2.5 mb-6"><AlertCircle size={13}/> {error}</p>}
      <button onClick={tryUnlock} disabled={busy} className="bg-white text-gray-950 px-8 py-3.5 rounded-2xl font-black text-sm flex items-center gap-2 mb-4">
        {busy && <Spinner dark/>} {busy ? "جارٍ التحقق..." : "المحاولة مرة أخرى"}
      </button>
      <button onClick={onResetLock} className="text-gray-500 text-xs font-semibold underline">تعذّر التحقق؟ سجّل الخروج وادخل من جديد</button>
    </div>
  );
}
    ...
    <div className="min-h-screen bg-white flex flex-col relative" dir="rtl">
      ...
      <div className="bg-gray-950 text-white flex flex-col items-center justify-center py-16 px-6 hero-surface">
        ...
        <div className="hero-wave-wrap" aria-hidden="true">
          <svg className="hero-wave hero-wave-back" viewBox="0 0 2400 100" preserveAspectRatio="none">
            <path d="M0,50 C75,32 75,32 150,50 C225,68 225,68 300,50 C375,32 375,32 450,50 C525,68 525,68 600,50 C675,32 675,32 750,50 C825,68 825,68 900,50 C975,32 975,32 1050,50 C1125,68 1125,68 1200,50 C1275,32 1275,32 1350,50 C1425,68 1425,68 1500,50 C1575,32 1575,32 1650,50 C1725,68 1725,68 1800,50 C1875,32 1875,32 1950,50 C2025,68 2025,68 2100,50 C2175,32 2175,32 2250,50 C2325,68 2325,68 2400,50 L2400,100 L0,100 Z" fill="#ffffff"/>
          </svg>
          <svg className="hero-wave hero-wave-front" viewBox="0 0 2400 100" preserveAspectRatio="none">
            <path d="M0,50 C75,32 75,32 150,50 C225,68 225,68 300,50 C375,32 375,32 450,50 C525,68 525,68 600,50 C675,32 675,32 750,50 C825,68 825,68 900,50 C975,32 975,32 1050,50 C1125,68 1125,68 1200,50 C1275,32 1275,32 1350,50 C1425,68 1425,68 1500,50 C1575,32 1575,32 1650,50 C1725,68 1725,68 1800,50 C1875,32 1875,32 1950,50 C2025,68 2025,68 2100,50 C2175,32 2175,32 2250,50 C2325,68 2325,68 2400,50" fill="none" stroke="#ffffff" strokeWidth="2.5"/>
          </svg>
        </div>
      </div>
...
function SudanPhoneField({ value, onChange, error, label }) {
  const valid = isValidSudanPhone(value);
  ...
  return (
    <div>
      <div className="flex items-center justify-between gap-2 mb-2">
        ...
        {carrier && (
          <span className="inline-flex items-center gap-1.5 text-xs font-black px-2.5 py-0.5 rounded-full flex-shrink-0" style={{color:carrier.color, background:carrier.color+"1A"}}>
            <span className="w-1.5 h-1.5 rounded-full" style={{background:carrier.color}}/>{carrier.name}
          </span>
        )}
      </div>
...
function LoginScreen({ role, onAuthed, onBack, prefillUsername }) {
  ...
  const submitUsername = async () => {
    ...
    try {
      ...
      setFormError(friendlyError(e, "تعذّر تسجيل الدخول، حاول مرة أخرى"));
      setShakeKey(k => k + 1);
    } finally {
      setLoading(false);
    }
  ...
  const submitGoogle = async () => {
    ...
    try {
      ...
      setFormError(friendlyError(e, "تعذّر تسجيل الدخول عبر Google"));
    } finally {
    ...
    <div className="min-h-screen bg-white flex flex-col" dir="rtl">
      ...
      <div className="flex-1 p-6 flex flex-col gap-4 mt-2">
        <button onClick={submitGoogle} disabled={busy} type="button"
          className="w-full bg-white border-2 py-3.5 rounded-xl font-bold text-base flex items-center justify-center gap-3 active:scale-95 transition-transform"
...
// ── تأكيد رقم الهاتف — خطوة تحقّق أخيرة قبل الحفظ، لأن السائق يتواصل عبر هذا الرقم بالتحديد ──
function PhoneConfirmModal({ open, phone, role, onConfirm, onEdit, loading }) {
  if (!open) return null;
  const warnText = role === "driver"
    ? "تأكد من كتابة رقمك بشكل صحيح، لأن العملاء يتواصلون معك من خلال رقم هاتفك هذا."
    : "تأكد من كتابة رقمك بشكل صحيح، لأن السائق يتواصل معك من خلال رقم هاتفك هذا.";
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4" style={{background:"rgba(10,10,10,.55)"}} onClick={onEdit}>
      <div className="w-full bg-white rounded-3xl p-6" style={{maxWidth:380}} onClick={e=>e.stopPropagation()}>
        <div className="w-12 h-12 bg-gray-50 rounded-2xl flex items-center justify-center mb-4"><Phone size={20} className="text-gray-700"/></div>
        <h3 className="font-black text-gray-950 text-lg mb-2">تأكيد رقم هاتفك</h3>
        <p className="text-gray-500 text-sm mb-4 leading-relaxed">{warnText}</p>
        <div className="bg-gray-50 rounded-xl p-4 text-center mb-6">
          <p className="font-black text-gray-950 text-lg" dir="ltr">{phone}</p>
        </div>
        <div className="flex gap-3">
          <button onClick={onEdit} disabled={loading} className="flex-1 border-2 text-gray-700 py-3.5 rounded-xl font-bold text-sm" style={{borderColor:"var(--bc-a)"}}>تعديل</button>
          <button onClick={onConfirm} disabled={loading} className="flex-1 bg-gray-950 text-white py-3.5 rounded-xl font-bold text-sm flex items-center justify-center gap-2">
...
function CompleteProfileScreen({ account, onDone, onLogout }) {
  ...
  const validate = () => {
    ...
    else if (!isValidSudanPhone(phoneDigits)) errs.phone = t("err_phone_invalid");
  ...
  const continueClick = () => { if (validate()) setShowPhoneConfirm(true); };
  ...
  const submit = async () => {
    ...
    try {
      ...
      setFormError(friendlyError(e, "تعذّر حفظ بياناتك، حاول مرة أخرى"));
      setShakeKey(k => k + 1);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col" dir="rtl">
      ...
      <div className="flex-1 p-6 flex flex-col gap-4 mt-2">
        ...
        <button onClick={continueClick} disabled={loading}
      ...
      <PhoneConfirmModal
        ...
        phone={toSudanE164(localPhone)}
        role={account.role}
        loading={loading}
        onConfirm={submit}
        onEdit={()=>setShowPhoneConfirm(false)}
      />
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col" dir="rtl">
      <div className="flex-1 overflow-auto pb-20 view-transition" key={view}>
        ...
        {view==="form"          && <CForm     setView={setView} form={form} setForm={setForm} profile={profile}/>}
...
function CHome({ setView, profile, activeOrder, setForm, onTrack }) {
  ...
  const startOrder = () => {
    if (activeOrder) { setShowActiveWarning(true); return; }
    setView("form");
  };
  return (
    <div>
      ...
      {showActiveWarning && activeOrder && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4" style={{background:"rgba(10,10,10,.55)"}} onClick={()=>setShowActiveWarning(false)}>
          <div className="w-full bg-white rounded-3xl p-6" style={{maxWidth:380}} onClick={e=>e.stopPropagation()}>
            <div className="w-12 h-12 bg-amber-50 rounded-2xl flex items-center justify-center mb-4"><AlertCircle size={22} className="text-amber-500"/></div>
            <h3 className="font-black text-gray-950 text-lg mb-2">لديك طلب نشط بالفعل</h3>
            <p className="text-gray-500 text-sm mb-1">طلب <span className="font-mono">{activeOrder.id}</span> ما زال {activeOrder.status==="pending" ? "بانتظار سائق" : "قيد التوصيل"}.</p>
            <p className="text-gray-500 text-sm mb-6">يمكنك الذهاب لمتابعته أو إلغاؤه، أو إضافة طلب جديد بجانبه مباشرة.</p>
            <div className="space-y-2.5">
              <button onClick={()=>{ setShowActiveWarning(false); onTrack(); }} className="w-full bg-gray-950 text-white py-3.5 rounded-xl font-bold text-sm">
                الذهاب للطلب النشط
              </button>
              <button onClick={()=>{ setShowActiveWarning(false); setView("form"); }} className="w-full border-2 text-gray-700 py-3.5 rounded-xl font-bold text-sm" style={{borderColor:"var(--bc-a)"}}>
                إضافة طلب جديد على أي حال
              </button>
            </div>
          </div>
        </div>
...
// ── بيانات نقطة التسليم — نموذج نصّي منظّم بدل اختيار نقطة على الخريطة، حتى لا
...
// ── اختيار المنطقة عبر بحث حي حقيقي — Nominatim (OpenStreetMap) مُقيَّد بالسودان
// فقط (countrycodes=sd)، لا قائمة ثابتة محدودة قد ينقصها اسم مدينة أو حي. كل
// نتيجة تصل بإحداثياتها الحقيقية مباشرة من الخريطة، فالمسافة محسوبة من موقع حقيقي
// فعلاً دائماً — لا تخمين ولا افتراض. القائمة الثابتة تبقى فقط كاقتراحات سريعة
// عند فراغ خانة البحث، وليست مصدر التحقق أبداً. ──────────────────────────────────
function SudanAreaSearchScreen({ initial, onSelect, onCancel }) {
  useScrollLock(true);
  ...
  useEffect(() => {
    ...
    debounceRef.current = setTimeout(async () => {
      try {
        const res = await fetch(`https://nominatim.openstreetmap.org/search?format=json&q=${encodeURIComponent(q)}&countrycodes=sd&addressdetails=1&limit=12&accept-language=ar`);
        const data = await res.json();
  ...
  return (
    <div className="fixed inset-0 z-50 bg-white flex flex-col" dir="rtl">
      <div className="bg-gray-950 text-white p-5 pt-14 flex items-center gap-3 flex-shrink-0">
        <button onClick={onCancel} aria-label="إلغاء" className="w-9 h-9 bg-gray-800 rounded-full flex items-center justify-center flex-shrink-0"><X size={16}/></button>
        <div className="min-w-0">
          <h2 className="text-lg font-black truncate">اختر منطقتك</h2>
          <p className="text-gray-400 text-xs mt-0.5">ابحث عن أي ولاية أو مدينة أو حي في السودان</p>
        </div>
      </div>
      <div className="p-4 border-b flex-shrink-0" style={{borderColor:"var(--bc-a)"}}>
        <div className="relative">
          <SearchIcon size={16} className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-300"/>
          <input value={query} onChange={e=>setQuery(e.target.value)} autoFocus placeholder="مثال: بحري، بورتسودان، شارع النيل..."
            aria-label="ابحث عن منطقتك" autoComplete="off"
      ...
      <div className="flex-1 overflow-auto">
        {searching && (
          <div className="p-4 space-y-3">{[1,2,3].map(i=><SkeletonLine key={i} h={50}/>)}</div>
        )}
        {!searching && searched && results.length === 0 && (
          <EmptyState Icon={MapPin} title="لا توجد نتائج" subtitle="تأكد من كتابة اسم ولاية أو مدينة أو منطقة حقيقية في السودان"/>
        )}
        {!searching && results.map((r,i) => (
          <button key={r.place_id||i} type="button" onClick={()=>pick(r)}
            className="w-full flex items-start gap-3 px-4 py-3.5 text-right border-b active:bg-gray-50 transition-colors" style={{borderColor:"var(--bc-c)"}}>
            <MapPin size={17} className="text-gray-400 flex-shrink-0 mt-0.5"/>
            <span className="text-sm font-semibold text-gray-800 leading-relaxed">{r.display_name}</span>
          </button>
        ))}
        {!query.trim() && (
          <div className="p-4">
            <p className="text-xs font-black text-gray-400 uppercase tracking-wider mb-3">مناطق شائعة في الخرطوم</p>
            <div className="space-y-1">
              {NEIGHBORHOODS.slice(0,12).map(n => (
                <button key={n.name} type="button" onClick={()=>onSelect({ name:n.name, lat:n.lat, lng:n.lng })}
                  className="w-full flex items-center gap-3 px-2 py-2.5 text-right active:bg-gray-50 rounded-xl transition-colors">
...
function DropoffDetailsScreen({ initial, profile, onConfirm, onCancel }) {
  useScrollLock(true);
  const [forWhom, setForWhom] = useState((initial && initial.forWhom) || null); // null | "self" | "other"
  const [phone, setPhone] = useState((initial && initial.phone) || "");
  const [name, setName] = useState((initial && initial.name) || "");
  const [area, setArea] = useState((initial && initial.area) || "");
  const [areaLoc, setAreaLoc] = useState((initial && initial.areaLoc) || null); // {lat,lng} حقيقية من البحث الحي
  ...
  const selectArea = (sel) => {
    setArea(sel.name);
    setAreaLoc({ lat: sel.lat, lng: sel.lng });
    setAreaPicker(false);
    if (errors.area) setErrors(er => { const n = { ...er }; delete n.area; return n; });
  };
  ...
  const validate = () => {
    ...
    if (forWhom === "other") {
      ...
      if (!phoneDigits) errs.phone = "رقم هاتف المستلم مطلوب";
      else if (!isValidSudanPhone(phoneDigits)) errs.phone = "رقم الهاتف غير صحيح";
      if (!name.trim()) errs.name = "اسم المستلم مطلوب";
    }
    if (!areaLoc) errs.area = "الرجاء اختيار منطقة حقيقية من نتائج البحث";
    setErrors(errs);
    if (Object.keys(errs).length) setShakeKey(k => k + 1);
    return Object.keys(errs).length === 0;
  };
  ...
  const confirm = async () => {
    ...
    try {
      ...
      const loc = { lat: areaLoc.lat, lng: areaLoc.lng };
      const label = [streetTrim, area].filter(Boolean).join("، ");
      const noteLines = forWhom === "other"
        ? [`هاتف المستلم: ${toSudanE164(phone)}`, `الاسم: ${name.trim()}`, details.trim() ? `تفاصيل إضافية: ${details.trim()}` : null].filter(Boolean).join("\n")
        : (details.trim() ? `تفاصيل إضافية: ${details.trim()}` : "");
      onConfirm({ label, loc, notes: noteLines, raw: { forWhom, phone, name, area, areaLoc, street: streetTrim, details } });
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="fixed inset-0 z-50 bg-white flex flex-col" dir="rtl">
      <div className="bg-gray-950 text-white p-5 pt-14 flex items-center gap-3 flex-shrink-0">
        ...
        <div className="min-w-0">
          <h2 className="text-lg font-black truncate">بيانات التسليم</h2>
          <p className="text-gray-400 text-xs mt-0.5">إلى أين نوصّل طلبك؟</p>
        </div>
      </div>

      {forWhom === null ? (
        <div className="flex-1 overflow-auto p-5">
          <p className="text-sm font-bold text-gray-500 mb-4">لمن هذا التوصيل؟</p>
          <div className="space-y-3">
            <button onClick={()=>setForWhom("self")} className="w-full bg-white border-2 rounded-2xl p-5 flex items-center gap-4 text-right active:scale-[.98] transition-transform" style={{borderColor:"var(--bc-a)"}}>
              <div className="w-12 h-12 bg-gray-100 rounded-2xl flex items-center justify-center flex-shrink-0"><User size={20} className="text-gray-700"/></div>
              <div className="flex-1 min-w-0">
                <p className="font-black text-gray-950">لنفسي</p>
                <p className="text-gray-400 text-xs mt-0.5">هاتفك المسجَّل يُستخدم للتواصل</p>
              </div>
              <ChevronRight size={16} className="text-gray-300 flex-shrink-0" style={{transform:"scaleX(-1)"}}/>
            </button>
            <button onClick={()=>setForWhom("other")} className="w-full bg-white border-2 rounded-2xl p-5 flex items-center gap-4 text-right active:scale-[.98] transition-transform" style={{borderColor:"var(--bc-a)"}}>
              <div className="w-12 h-12 bg-gray-100 rounded-2xl flex items-center justify-center flex-shrink-0"><Users size={20} className="text-gray-700"/></div>
              <div className="flex-1 min-w-0">
                <p className="font-black text-gray-950">لشخص آخر</p>
                <p className="text-gray-400 text-xs mt-0.5">أدخل اسم ورقم هاتف المستلم</p>
              </div>
              <ChevronRight size={16} className="text-gray-300 flex-shrink-0" style={{transform:"scaleX(-1)"}}/>
            </button>
          </div>
        ...
        <>
          <div className="flex-1 overflow-auto p-5 space-y-4">
            <button onClick={()=>setForWhom(null)} className="text-xs font-bold text-gray-400 underline">تغيير — {forWhom==="self" ? "لنفسي" : "لشخص آخر"}</button>

            {forWhom === "other" && (
              <div className="bg-white border-2 rounded-2xl overflow-hidden" style={{borderColor: (errors.phone||errors.name) ? "#EF4444" : "var(--bc-a)"}}>
                ...
                <div className="px-4 pb-4" key={errors.name ? `nm-${shakeKey}` : "nm"}>
                  <div className={errors.name ? "moter-shake" : ""}>
                    <label className="text-sm font-semibold text-gray-700 block mb-2"><RequiredDot/>اسم المستلم</label>
                    <div className="relative">
                      <User size={16} className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-300"/>
                      <input value={name} onChange={e=>setName(e.target.value)} aria-label="اسم المستلم"
                        className="w-full border-2 rounded-xl pr-11 pl-4 py-3.5 text-gray-950 focus:outline-none transition-colors" style={{borderColor: errors.name ? "#EF4444" : "var(--bc-b)"}}/>
                    </div>
                    {errors.name && <p className="moter-field-error"><AlertCircle size={13}/> {errors.name}</p>}
                  </div>
                </div>
            ...
            <div className="bg-white border-2 rounded-2xl overflow-hidden" style={{borderColor: errors.area ? "#EF4444" : "var(--bc-a)"}}>
              ...
              <div className="p-4 pt-3" key={errors.area ? `ar-${shakeKey}` : "ar"}>
                <div className={errors.area ? "moter-shake" : ""}>
                  ...
                  <button type="button" onClick={()=>setAreaPicker(true)}
                    className="w-full border-2 rounded-xl pr-11 pl-4 py-3.5 text-right relative transition-colors" style={{borderColor: errors.area ? "#EF4444" : "var(--bc-b)"}}>
                    <MapPin size={16} className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-300"/>
                    {areaLoc
                      ? <span className="text-gray-950 font-semibold text-sm block truncate pl-6">{area}</span>
                      : <span className="text-gray-300 text-sm">اختر منطقتك من البحث</span>}
                    {areaLoc && <CheckCircle size={18} className="text-green-500 absolute left-3.5 top-1/2 -translate-y-1/2"/>}
                  </button>
                  {errors.area ? <p className="moter-field-error"><AlertCircle size={13}/> {errors.area}</p>
                    : <p className="text-gray-400 text-xs mt-1.5">اكتب واختر من القائمة — مدينة أو منطقة حقيقية في السودان فقط</p>}
                </div>
              </div>
              ...
              <div className="px-4 pb-3">
                ...
                <div className="relative">
                  ...
                  <input value={street} onChange={e=>setStreet(e.target.value)} aria-label="الشارع"
                    className="w-full border-2 rounded-xl pr-11 pl-4 py-3.5 text-gray-950 focus:outline-none transition-colors" style={{borderColor:"var(--bc-b)"}}/>
                </div>
              </div>
              ...
              <div className="px-4 pb-4">
                ...
                <textarea value={details} onChange={e=>setDetails(e.target.value)} rows={3} aria-label="تفاصيل إضافية"
                  className="w-full border-2 rounded-xl px-4 py-3.5 text-gray-950 focus:outline-none transition-colors resize-none" style={{borderColor:"var(--bc-b)"}}/>
                <p className="text-gray-400 text-xs mt-1.5">أي علامة مميزة تساعد السائق على الوصول</p>
              </div>
            </div>
          </div>

          <div className="p-5 border-t flex-shrink-0" style={{borderColor:"var(--bc-a)"}}>
            <button onClick={confirm} disabled={loading} className="w-full bg-gray-950 text-white py-4 rounded-xl font-black text-base active:scale-95 transition-transform flex items-center justify-center gap-2">
              {loading && <Spinner/>} {loading ? "جارٍ التأكيد..." : "تأكيد بيانات التسليم"}
            </button>
          </div>
        </>
      )}
      ...
      {areaPicker && (
        <SudanAreaSearchScreen initial={area} onSelect={selectArea} onCancel={()=>setAreaPicker(false)}/>
      )}
    </div>
  );
}

function CForm({ setView, form, setForm, profile }) {
  const [errors, setErrors] = useState({});
  const [dropoffFormOpen, setDropoffFormOpen] = useState(false);
  const [shakeKey, setShakeKey] = useState(0);
  const [pickupStatus, setPickupStatus] = useState(form.pickupLoc ? "ready" : "loading"); // loading | ready | error

  const captureMyLocation = () => {
    if (!navigator.geolocation) { setPickupStatus("error"); return; }
    setPickupStatus("loading");
    navigator.geolocation.getCurrentPosition(
      async (pos) => {
        const loc = { lat: pos.coords.latitude, lng: pos.coords.longitude };
        const label = await reverseGeocode(loc.lat, loc.lng);
        setForm(f => ({ ...f, pickup: label, pickupLoc: loc }));
  ...
  useEffect(() => { if (!form.pickupLoc) captureMyLocation(); }, []); // eslint-disable-line react-hooks/exhaustive-deps

  const validate = () => {
    const errs = {};
    if (!form.pickupLoc) errs.pickup = "لازم نحدّد موقعك أولاً — فعّل صلاحية الموقع وحاول مجدداً";
    if (!form.dropoffLoc) errs.dropoff = "الرجاء إدخال بيانات التسليم";
  ...
  const confirmDropoff = ({ label, loc, notes, raw }) => {
    setForm(f => ({
      ...f,
      dropoff: label,
      dropoffLoc: loc,
      dropoffDetails: raw,
      notes: [notes, f.notes && !f.notes.startsWith("هاتف المستلم:") ? f.notes : ""].filter(Boolean).join("\n"),
    }));
    setDropoffFormOpen(false);
  };
  ...
  return (
    <div>
      <div className="bg-gray-950 text-white p-5 pt-14">
        ...
        <p className="text-gray-400 text-sm mt-1">موقعك الحالي هو نقطة الاستلام — أدخل بيانات التسليم</p>
      </div>
      <div className="p-5 space-y-5">
        <div key={(errors.pickup||errors.dropoff) ? `loc-${shakeKey}` : "loc"} className={(errors.pickup||errors.dropoff) ? "moter-shake" : ""}>
          <div className="bg-white border-2 rounded-2xl overflow-hidden" style={{borderColor: (errors.pickup||errors.dropoff) ? "#EF4444" : "var(--bc-a)"}}>
            <div className="w-full p-4 border-b flex items-center gap-3" style={{borderColor:"var(--bc-c)"}}>
              <div className="w-3 h-3 bg-gray-950 rounded-full flex-shrink-0"/>
              <div className="flex-1 min-w-0">
                <label className="text-xs font-bold text-gray-400 uppercase tracking-wider block mb-1">نقطة الاستلام (موقعك الحالي)</label>
                {pickupStatus === "loading" && <span className="flex items-center gap-2 text-gray-400 text-sm font-semibold"><Spinner dark/> جارٍ تحديد موقعك...</span>}
                {pickupStatus === "ready" && <span className="text-gray-950 font-semibold text-sm block truncate">{form.pickup}</span>}
                {pickupStatus === "error" && <span className="text-red-500 text-sm font-semibold">تعذّر تحديد موقعك — فعّل صلاحية الموقع</span>}
              </div>
              {pickupStatus !== "loading" && (
                <button type="button" onClick={captureMyLocation} aria-label="تحديث موقعي الحالي" className="w-9 h-9 rounded-full bg-gray-50 flex items-center justify-center flex-shrink-0 active:scale-90 transition-transform">
                  <Crosshair size={15} className="text-gray-500"/>
                </button>
              )}
            </div>
            <button type="button" onClick={()=>setDropoffFormOpen(true)} className="w-full p-4 text-right active:bg-gray-50 transition-colors">
              ...
              <div className="flex items-center gap-3 mt-2">
                ...
                {form.dropoffLoc
                  ...
                  : <span className="flex-1 text-gray-300 font-semibold min-w-0">اضغط لإدخال بيانات التسليم</span>}
                <ChevronRight size={16} className="text-gray-400 flex-shrink-0" style={{transform:"scaleX(-1)"}}/>
              </div>
            </button>
          </div>
      ...
      {dropoffFormOpen && (
        <DropoffDetailsScreen
          initial={form.dropoffDetails}
          profile={profile}
          onConfirm={confirmDropoff}
          onCancel={()=>setDropoffFormOpen(false)}
        />
      )}
    </div>
  );
...
function CPreview({ setView, form, profile, addOrder, onConfirmed }) {
  ...
  const [justConfirmed, setJustConfirmed] = useState(null); // معرّف الطلب أثناء لحظة النجاح القصيرة قبل الانتقال
  ...
  useEffect(() => {
    const unsub = usersCol.where("role","==","driver").where("online","==",true)
      .onSnapshot((snap) => setOnlineCount(snap.docs.filter(d => isDriverOnline(d.data())).length), () => setOnlineCount(null));
    return unsub;
  }, []);
  ...
  const confirm = async () => {
    ...
    try {
      ...
      setJustConfirmed(newOrder.id);
      setTimeout(() => onConfirmed(newOrder.id), 900);
    } catch (e) {
  ...
  if (justConfirmed) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-white" dir="rtl">
        <svg width="88" height="88" viewBox="0 0 88 88" className="moter-check-draw mb-5">
          <circle cx="44" cy="44" r="40" fill="none" stroke="#0A0A0A" strokeWidth="4"/>
          <path d="M27 45l12 12 22-24" fill="none" stroke="#0A0A0A" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
        <p className="font-black text-gray-950 text-lg">تم تأكيد طلبك</p>
        <p className="text-gray-400 text-sm mt-1">{justConfirmed}</p>
      </div>
    );
  }
...
function NearbyDriversMap({ profile }) {
  ...
  useEffect(() => {
    const unsub = usersCol.where("role", "==", "driver").where("online", "==", true)
      .onSnapshot((snap) => {
        setDrivers(snap.docs.map(d => ({ ...d.data(), id: d.id })).filter(d => d.location && d.id !== (profile && profile.id) && isDriverOnline(d)));
      }, () => {});
    return unsub;
  }, [profile && profile.id]);

  // إعادة تقييم "حداثة" كل سائق دورياً — سائق قد يصبح غير متصل فعلياً (نبضته
  // تجمّدت) من غير أي كتابة جديدة على Firestore تُحرّك onSnapshot من تلقاء نفسها
  useEffect(() => {
    const id = setInterval(() => {
      setDrivers(prev => prev.filter(isDriverOnline));
    }, 20000);
...
function CTracking({ setView, order, updateOrder }) {
  ...
  const submitRating = async (v) => {
    setRating(v);
    setPoppedStar(v);
    setTimeout(() => setPoppedStar(0), 350);
              ...
              <div className="flex justify-center gap-3 mb-4">
                {[1,2,3,4,5].map(s=>(
                  <button key={s} onClick={()=>submitRating(s)} disabled={!!order.rating}
                    className={`active:scale-110 transition-transform ${poppedStar===s ? "moter-star-pop" : ""}`}>
...
function CHistory({ orders }) {
  ...
  const copyId = (id) => { try { navigator.clipboard.writeText(id); showToast("تم نسخ رقم الطلب"); } catch (e) {} };
  return (
    <div>
      <div className="bg-gray-950 text-white p-5 pt-14">
      ...
      <div className="p-4 space-y-3">
        {shown.map((o,i)=>{
          return (
          <div key={o.id} className="moter-card-stagger bg-white border rounded-2xl overflow-hidden" style={{borderColor:"var(--bc-a)", animationDelay:`${Math.min(i,8)*0.04}s`}}>
            <div className="flex justify-between items-center p-4 pb-3 gap-2">
              <button onClick={()=>copyId(o.id)} aria-label="نسخ رقم الطلب" className="flex items-center gap-1.5 text-xs font-mono text-gray-400 bg-gray-50 px-2.5 py-1 rounded-lg active:scale-95 transition-transform">
                {o.id} <Copy size={11}/>
              </button>
              <Badge status={o.status}/>
            </div>
            <div className="px-4 flex items-start gap-3 mb-3">
              <div className="flex flex-col items-center gap-1 mt-1 flex-shrink-0">
            ...
            <div className="px-4 pb-3 flex items-center gap-3 text-xs" style={{color:"var(--muted, #9CA3AF)"}}>
              <span className="flex items-center gap-1"><Calendar size={11}/> {o.date}</span>
              <span className="flex items-center gap-1"><Clock size={11}/> {o.time}</span>
              <span className="flex items-center gap-1"><MapPin size={11}/> {o.distance} كم</span>
            </div>
            <div className="flex justify-between items-center px-4 py-3 border-t text-xs bg-gray-50" style={{borderColor:"var(--bc-c)"}}>
              <span className="text-gray-500 truncate flex-1">{o.item}</span>
              <span className="font-black text-gray-950 flex-shrink-0">{fmtNum(o.price)} ج.س</span>
            </div>
            {o.status === "delivered" && o.rating && (
              <div className="flex justify-end px-4 pb-3 pt-1"><RatingStars value={o.rating} size={11}/></div>
            )}
          </div>
        );})}
      </div>
...
function CDriversList({ setView }) {
  ...
  const [query, setQuery] = useState("");
  const [, forceTick] = useState(0); // لإعادة تقييم "حالة الاتصال الفعلية" دورياً حتى بلا بيانات جديدة من Firestore
    ...
    const unsub = usersCol.where("role","==","driver").where("profileComplete","==",true)
      .onSnapshot(
        (snap) => {
          ...
          list.sort((a,b) => (isDriverOnline(b)?1:0)-(isDriverOnline(a)?1:0) || String(a.name||"").localeCompare(String(b.name||""),"ar"));
          setDrivers(list);
        },
        () => setDrivers([])
      );
  ...
  useEffect(() => {
    const id = setInterval(() => forceTick(v => v + 1), 20000);
    return () => clearInterval(id);
  }, []);
  ...
  const onlineCount = drivers ? drivers.filter(isDriverOnline).length : 0;
    ...
    <div>
      ...
      {drivers === null ? (
        ...
        <div className="divide-y" style={{borderColor:"var(--bc-c)"}}>
          {shown.map((d,i) => { const online = isDriverOnline(d); return (
            <div key={d.id} className="moter-card-stagger flex items-center gap-3 px-4 py-3" style={{animationDelay:`${Math.min(i,8)*0.04}s`}}>
              <div className="relative flex-shrink-0" style={{width:52,height:52}}>
                ...
                <span className={`absolute -bottom-0.5 -left-0.5 w-3.5 h-3.5 rounded-full border-2 border-white ${online ? "moter-dot-breathe" : ""}`} style={{background: online ? "#22C55E" : "#D1D5DB"}}/>
              </div>
              <div className="flex-1 min-w-0">
                <p className="font-bold text-gray-950 text-sm truncate">{d.name}</p>
                <p className={`text-xs font-semibold ${online ? "text-green-600" : "text-gray-400"}`}>{online ? "متصل الآن" : "غير متصل"}</p>
              </div>
...
function DOrders({ pending, profile, setView }) {
  ...
  // تمييز الطلبات الجديدة الواصلة أثناء فتح الشاشة فقط — لا الدفعة الأولى عند التحميل
  const seenIds = useRef(null);
  const [freshIds, setFreshIds] = useState(() => new Set());
  useEffect(() => {
    const currentIds = new Set(pending.map(o => o.id));
    if (seenIds.current === null) {
      seenIds.current = currentIds; // أول تحميل — لا تمييز
      return;
    }
    const arrived = pending.filter(o => !seenIds.current.has(o.id)).map(o => o.id);
    if (arrived.length) {
      setFreshIds(prev => new Set([...prev, ...arrived]));
      arrived.forEach(id => setTimeout(() => setFreshIds(prev => { const n = new Set(prev); n.delete(id); return n; }), 2600));
    }
  ...
  const accept = async (o) => {
    ...
    try {
      ...
      showToast(friendlyError(e, "تعذّر قبول الطلب"), "error");
    } finally {
      setAcceptingId(null);
    }
  };
  ...
  return (
    <div>
      ...
      <div className="p-4 space-y-4">
        {shown.map((o,i)=>{
          return (
          <div key={o.id} className={`moter-card-stagger bg-white border-2 rounded-2xl overflow-hidden ${freshIds.has(o.id) ? "moter-new-flash" : ""}`} style={{borderColor:"var(--bc-a)", animationDelay:`${Math.min(i,8)*0.04}s`}}>
            <div className="p-4">
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center px-4 pb-4 sm:items-center sm:pb-0" style={{background:"rgba(10,10,10,0.55)"}}>
      <div className="w-full bg-white rounded-3xl p-6" style={{maxWidth:420}} onClick={e=>e.stopPropagation()}>
        ...
        <div className="flex gap-3">
          ...
          <button onClick={onConfirm} disabled={loading} className={`flex-1 py-3.5 rounded-xl font-black text-white active:scale-95 transition-transform flex items-center justify-center gap-2 ${danger?"bg-red-500":"bg-gray-950"}`}>
            {loading && <Spinner/>}
...
function ChangePasswordModal({ open, onClose, profile }) {
  ...
  const submit = async () => {
    ...
    try {
      ...
      setErrors({ current: friendlyError(e, "تعذّر تغيير كلمة المرور") });
      setShakeKey(k=>k+1);
    } finally {
      setLoading(false);
    }
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center px-4 pb-4 sm:items-center sm:pb-0" style={{background:"rgba(10,10,10,0.55)"}} onClick={close}>
      <div className="w-full bg-white rounded-3xl p-6" style={{maxWidth:420}} onClick={e=>e.stopPropagation()}>
        ...
        <div className="flex gap-3 mt-5">
          ...
          <button onClick={submit} disabled={loading} className="flex-1 py-3.5 rounded-xl font-black text-white bg-gray-950 flex items-center justify-center gap-2 active:scale-95 transition-transform">
...
function SettingsScreen({ setView, backTo, profile, setProfile, roleLabel, currentRole, onSwitchRole, onAccountDeleted, onLogout }) {
  ...
  const [shakeKey, setShakeKey] = useState(0);
  const [lockState, setLockState] = useLocalStorageState(LS_LOCK, { enabled:false, credentialId:null });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setSaveError(friendlyError(e, "تعذّر حفظ التغييرات، حاول مرة أخرى"));
      setShakeKey(k=>k+1);
    } finally {
      setSaving(false);
    }
  ...
  const confirmDeleteAccount = async () => {
    ...
    try {
      ...
      showToast(friendlyError(e, "تعذّر حذف الحساب"), "error");
      setDeleting(false);
    }
  };
    ...
    try {
      if (!lockState.enabled) {
        if (!(await biometricSupported())) {
          showToast("جهازك أو متصفحك لا يدعم القفل بالبصمة", "error");
          return;
        }
        const credentialId = await registerBiometric(profile.id, profile.name);
        setLockState({ enabled: true, credentialId });
        showToast("تم تفعيل قفل التطبيق بالبصمة");
      } else {
        // نطلب بصمة تأكيدية قبل إلغاء القفل — لا يكفي مجرد الوصول للإعدادات لتعطيله
        await verifyBiometric(lockState.credentialId);
        setLockState({ enabled: false, credentialId: null });
        showToast("تم إلغاء قفل التطبيق");
      }
    } catch (e) {
      showToast(lockState.enabled ? "تعذّر التحقق من البصمة — لم يُلغَ القفل" : "تعذّر تسجيل البصمة، حاول مرة أخرى", "error");
    } finally {
      setLockBusy(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50" dir="rtl">
      ...
      <div className="p-5 space-y-4 pb-12 max-w-full">
        ...
        {/* الأمان */}
        <div className="bg-white border rounded-2xl p-5" style={{borderColor:"var(--bc-a)"}}>
          <h3 className="font-black text-gray-950 mb-4">الأمان</h3>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 min-w-0">
              <div className="w-10 h-10 bg-gray-50 rounded-xl flex items-center justify-center flex-shrink-0"><Fingerprint size={17} className="text-gray-700"/></div>
              <div className="min-w-0">
                <p className="font-bold text-gray-950 text-sm">قفل التطبيق بالبصمة</p>
                <p className="text-gray-400 text-xs mt-0.5">يطلب بصمة جهازك عند كل فتح للتطبيق</p>
              </div>
            </div>
            <button onClick={toggleAppLock} disabled={lockBusy} aria-label="قفل التطبيق بالبصمة" aria-pressed={lockState.enabled}
              className={`relative w-12 h-6 rounded-full flex-shrink-0 transition-colors ${lockState.enabled?"bg-green-500":"bg-gray-200"}`}>
              <div className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-all ${lockState.enabled?"left-6":"left-0.5"}`}/>
            </button>
          </div>
        </div>
        ...
        <button onClick={()=>{ if (!validate()) return; const phoneChanged = toSudanE164(localPhone) !== profile.phone; if (phoneChanged) setShowPhoneConfirm(true); else handleSave(); }} disabled={saving || !dirty}
          className="w-full bg-gray-950 text-white py-4 rounded-xl font-black text-base active:scale-95 transition-transform flex items-center justify-center gap-2">
          {saving && <Spinner/>}
...
function AppShell() {
  ...
  if (lockState.enabled && !unlocked) {
    content = <LockScreen credentialId={lockState.credentialId} onUnlock={()=>setUnlocked(true)}
      onResetLock={async ()=>{ setLockState({ enabled:false, credentialId:null }); setUnlocked(true); await logout(); }}/>;
  } else if (authReady) {
    if (bannedNotice) content = <BannedScreen onDismiss={()=>{ setBannedNotice(false); setNavState({ ...NAV_DEFAULT }); }}/>;
    else if (screen === "welcome") content = <WelcomeScreen onSelect={select}/>;
