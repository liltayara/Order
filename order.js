...
// أن الرقم يبدأ بـ9 كما تشترطه شبكات السودان المحمولة.
    ...
    <div>
      ...
      {drivers === null ? (
        ...
        <div className="divide-y" style={{borderColor:"var(--bc-c)"}}>
          {shown.map(d => { const online = isDriverOnline(d); return (
            <div key={d.id} className="flex items-center gap-3 px-4 py-3">
              <div className="relative flex-shrink-0" style={{width:52,height:52}}>
                ...
                <span className="absolute -bottom-0.5 -left-0.5 w-3.5 h-3.5 rounded-full border-2 border-white" style={{background: online ? "#22C55E" : "#D1D5DB"}}/>
              </div>
              <div className="flex-1 min-w-0">
